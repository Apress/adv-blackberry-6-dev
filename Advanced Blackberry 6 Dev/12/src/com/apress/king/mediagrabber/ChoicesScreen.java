...
public class ChoicesScreen extends MainScreen implements MediaGrabberResource
{
    ...
    private MenuItem sendLogItem = new MenuItem(r, MediaGrabber.I18N_SEND_LOG, 0x10000, 0)
    {
        public void run()
        {
    ...
    private MenuItem updateItem = new MenuItem(r, MediaGrabber.I18N_UPGRADE_CHOICE, 0x20000, 0)
    {
        public void run()
        {
