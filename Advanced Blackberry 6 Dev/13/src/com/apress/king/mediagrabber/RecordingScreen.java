        ...
        MediaGrabberResource
{
    ...
    private MenuItem goItem = new MenuItem(r, I18N_COMMAND_GO, 0, 0)
    {
        public void run()
        {
            go();
    ...
    private MenuItem stopItem = new MenuItem(r, I18N_COMMAND_STOP, 0,
            0)
    {
        public void run()
        {
    ...
    private MenuItem doneItem = new MenuItem(r, I18N_COMMAND_RETURN,
            0, 0)
    {
        public void run()
        {
    ...
    private MenuItem playItem = new MenuItem(r, I18N_COMMAND_PLAY, 0,
            0)
    {
        public void run()
        {
    ...
    private MenuItem showItem = new MenuItem(r, I18N_COMMAND_SHOW, 0,
            0)
    {
        public void run()
        {
    ...
    private MenuItem sendItem = new MenuItem(r, I18N_COMMAND_SEND, 0,
            0)
    {
        public void run()
        {
    ...
    private MenuItem sendEncryptedItem = new MenuItem(r,
            I18N_COMMAND_SEND_ENCRYPTED, 0, 0)
    {
        public void run()
        {
            send(true);
    ...
    public RecordingScreen(int type, String location)
    {
        ...
        status = new LabelField(r, I18N_STATUS_WAITING);
        add(status);
    ...
    public void initMedia()
    {
        try
        {
            ...
            state = STATE_READY;
            status.setText(r, I18N_STATUS_READY);
        }
    ...
    private void go()
    {
        ...
        else
        {
            ...
            if (recorder != null)
            {
                ...
                status.setText(r, I18N_STATUS_RECORDING);
            }
        }
    }
    ...
    private void takeSnapShot()
    {
        try
        {
            ...
            {
                status.setText(r, I18N_ERROR_NO_PICTURE_DATA);
            }
        }
        catch (IOException ioe)
        {
    ...
    private void stop()
    {
        try
        {
            if (type == RECORD_AUDIO || type == RECORD_VIDEO)
            {
                ...
                status.setText(r, I18N_STATUS_SAVED);
